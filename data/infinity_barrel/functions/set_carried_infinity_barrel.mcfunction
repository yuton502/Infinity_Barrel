#収納数を移す
execute as @e[tag=Carrying_Infinity_Barrel] store result score @s IB_data run data get entity @s Item.tag.Stored
execute as @e[tag=Carrying_Infinity_Barrel] if data entity @s Item.tag.RemoveTag run data remove entity @s Item.tag
execute as @e[tag=Carrying_Infinity_Barrel] unless data entity @s Item.tag.RemoveTag run data remove entity @s Item.tag.Stored
execute as @e[tag=Carrying_Infinity_Barrel] unless data entity @s Item.tag.RemoveTag run data remove entity @s Item.tag.UUID
